...
(custom-set-variables
 ...
 '(package-selected-packages
   '(sicp geiser-racket graphql-mode sqlite3 goto-line-preview markdown-mode treemacs typescript-mode forge magit org-modern geiser-chicken rainbow-delimiters ac-geiser paredit geiser-guile gnu-elpa-keyring-update geiser auto-complete smart-mode-line dimmer beacon dashboard page-break-lines auto-package-updates)))
(custom-set-faces
